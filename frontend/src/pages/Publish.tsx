      ...
      <div className="flex justify-center">
        <div className="w-full max-w-screen-lg">
          <input
            ...
            className="mt-8 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
            placeholder="Title"
          />
      ...
      <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 mt-4">
        <div className="flex items-center justify-between px-3 py-2 border-b ">
          <div className="flex flex-wrap items-center divide-gray-200 sm:divide-x sm:rtl:divide-x-reverse ">
            ...
            <div className="flex flex-wrap items-center space-x-1 rtl:space-x-reverse sm:ps-4">
              ...
              <button
                type="button"
                className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 d"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
        ...
        <div className="px-4 py-2 bg-white rounded-b-lg ">
          ...
          <textarea
            ...
            rows={8}
            onChange={onChange}
            className="pl-2 block w-full  px-0 text-sm text-gray-800 bg-white border-0 focus:outline-none "
